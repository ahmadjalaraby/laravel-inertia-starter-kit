<template>
  ...
  >
    <Icon icon="heroicons-outline:moon" v-if="!useThemeSettingsStore().isDark" />
    <Icon icon="heroicons-outline:sun" v-else-if="useThemeSettingsStore().isDark" />
  </span>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    toogleDark() {
        useThemeSettingsStore().toogleDark()
    },
  },
};
</script>
